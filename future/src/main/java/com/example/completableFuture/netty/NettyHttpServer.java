package com.example.completableFuture.netty;
...
public class NettyHttpServer {
    ...
    public static void main(String[] args) {
        ...
        EventExecutorGroup eventExecutors = new DefaultEventLoopGroup(4);

        try {
            ServerBootstrap serverBootstrap = new ServerBootstrap();
            var server = serverBootstrap.group(parentGroup, childGroup)
